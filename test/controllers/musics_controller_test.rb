...
class MusicsControllerTest < ActionController::TestCase
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post :create, music: { artist: @music.artist, genre: @music.genre, slug: @music.slug, song_api: @music.song_api, song_name: @music.song_name }
    end
  ...
  test "should update music" do
    patch :update, id: @music, music: { artist: @music.artist, genre: @music.genre, slug: @music.slug, song_api: @music.song_api, song_name: @music.song_name }
    assert_redirected_to music_path(assigns(:music))
  end
